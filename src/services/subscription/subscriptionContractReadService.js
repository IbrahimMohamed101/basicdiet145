...
function isGrandfatheredSubscriptionContract(subscription) {
  return Boolean(subscription && !isCanonicalSubscriptionContract(subscription));
}
...
function getSubscriptionContractDiagnostics(subscription, {
  ...
  pushMismatch(mismatches, "subtotalHalala", snapshotPricing.subtotalHalala, subscription && subscription.subtotalHalala);
  pushMismatch(mismatches, "vatPercentage", snapshotPricing.vatPercentage, subscription && subscription.vatPercentage);
  pushMismatch(mismatches, "vatHalala", snapshotPricing.vatHalala, subscription && subscription.vatHalala);
  pushMismatch(mismatches, "totalPriceHalala", snapshotPricing.totalHalala, subscription && subscription.totalPriceHalala);
  ...
  const contractMeta = audience === "admin"
    ? {
      ...
      mode: subscription && subscription.contractMode
        ...
        : grandfathered ? "legacy_grandfathered" : null,
