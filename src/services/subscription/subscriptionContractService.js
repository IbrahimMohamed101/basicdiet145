...
function buildPhase1SubscriptionContract({ payload = {}, resolvedQuote, actorContext = {}, source, now = new Date(), renewalSeed = null, currentBusinessDate = null } = {}) {
  ...
  const addonSubscriptions = (resolvedQuote.addonSubscriptions || []).map((as) => ({
    ...
    addonPlanNameI18n: as.addonPlanNameI18n || null,
    category: as.category || "",
    allowanceCategory: as.allowanceCategory || as.category || "",
    displayKey: as.displayKey || as.displayCategory || as.category || "",
    displayCategory: as.displayCategory || as.displayKey || as.category || "",
    sortOrder: Number(as.sortOrder || 0),
    ...
    menuCategoryKeys: Array.isArray(as.menuCategoryKeys) ? as.menuCategoryKeys : [],
