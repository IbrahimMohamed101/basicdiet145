...
router.post("/sections/:sectionKey/products", asyncHandler(controller.addProducts));
router.delete("/sections/:sectionKey/products/:productId", asyncHandler(controller.removeProduct));
